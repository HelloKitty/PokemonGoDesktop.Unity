...
namespace PokemonGoDesktop.Unity.HTTP
{
	...
	public abstract class AsyncRequestFutures<TResponseMessageType> : IFuture<IEnumerable<TResponseMessageType>>
		where TResponseMessageType : class, IResponseMessage, IMessage, new()
	{
		...
		/// </summary>
		public virtual IEnumerable<TResponseMessageType> Result { get; protected set; } = null;
	}
}
